...
const (
	...
	MinRetentionDaysGlacier     = 90
	MinRetentionDaysGlacierDeep = 180
	MinRetentionDaysStandard    = 0
	MinRetentionDaysWasabi      = 90
...
// MinRetentionDaysFor returns the minimum number of days an object
// or file must be stored in the specified storage option.
func MinRetentionDaysFor(storageOption string) int {
	days := 0
	switch storageOption {
	case StorageOptionGlacierDeepOH, StorageOptionGlacierDeepOR, StorageOptionGlacierDeepVA:
		days = MinRetentionDaysGlacierDeep
	case StorageOptionGlacierOH, StorageOptionGlacierOR, StorageOptionGlacierVA:
		days = MinRetentionDaysGlacier
	case StorageOptionWasabiOR, StorageOptionWasabiVA:
