...
const (
	...
	EventAccessAssignment           = 0 // "access assignment" // 2
	EventCapture                    = 0 // "capture"
	EventCompression                = 0 //"compression"
	EventCreation                   = 0 //"creation"
	EventDeaccession                = 0 //"deaccession"
	EventDecompression              = 0 //"decompression"
	EventDecryption                 = 0 //"decryption"
	EventDeletion                   = 0 //"deletion"
	EventDigestCalculation          = 0 //"message digest calculation"
	EventFixityCheck                = 0 //"fixity check"
	EventIdentifierAssignment       = 0 //"identifier assignment"
	EventIngestion                  = 0 //"ingestion"
	EventMigration                  = 0 //"migration"
	EventNormalization              = 0 //"normalization"
	EventReplication                = 0 //"replication"
	EventSignatureValidation        = 0 //"digital signature validation"
	EventValidation                 = 0 //"validation"
	EventVirusCheck                 = 0 //"virus check"
