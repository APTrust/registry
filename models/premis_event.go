...
type PremisEvent struct {
	...
	IntellectualObjectIdentifier string    `json:"intellectual_object_identifier" form:"intellectual_object_identifier" pg:"intellectual_object_identifier"`
	GenericFileIdentifier        string    `json:"generic_file_identifier" form:"generic_file_identifier" pg:"generic_file_identifier"`
