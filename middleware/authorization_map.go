...
var AuthMap = map[string]AuthMetadata{
	...
	"NsqTopicPause":                      {"NSQ", constants.NsqAdmin},
	"NsqTopicUnpause":                    {"NSQ", constants.NsqAdmin},
	"NsqTopicEmpty":                      {"NSQ", constants.NsqAdmin},
	"NsqTopicDelete":                     {"NSQ", constants.NsqAdmin},
	"NsqChannelPause":                    {"NSQ", constants.NsqAdmin},
	"NsqChannelUnpause":                  {"NSQ", constants.NsqAdmin},
	"NsqChannelEmpty":                    {"NSQ", constants.NsqAdmin},
	"NsqChannelDelete":                   {"NSQ", constants.NsqAdmin},
