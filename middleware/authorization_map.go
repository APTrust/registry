...
var AuthMap = map[string]AuthMetadata{
	...
	"UserGenerateTOTP":                   {"User", constants.UserGenerateTOTP, "Authenticator App Setup"},
	...
	"UserValidateTOTP":                   {"User", constants.UserValidateTOTP, "MFA Confirm TOTP Via Authenticator App"},
	"UserValidateTOTPView":               {"User", constants.UserValidateTOTPView, "MFA Confirm TOTP Via Authenticator App Form"},
