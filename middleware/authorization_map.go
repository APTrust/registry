...
var AuthMap = map[string]AuthMetadata{
	...
	"IntellectualObjectInitMove":         {"IntellectualObject", constants.IntellectualObjectMove, "Initialize Object Move"},
	...
	"IntellectualObjectRequestMove":      {"IntellectualObject", constants.IntellectualObjectMove, "Request Object Move"},
